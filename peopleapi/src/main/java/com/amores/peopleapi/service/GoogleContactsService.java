...
public class GoogleContactsService {
    ...
    // Add a new contact
    public String addContact(String accessToken, String firstName, String lastName,
    ...
    public String updateContact(String accessToken, String resourceName, String firstName,
            String lastName, String birthday, List<String> emails,
        ...
        String url = "https://people.googleapis.com/v1/" + resourceName + ":updateContact?updatePersonFields=" + updateMask;

        HttpHeaders headers = new HttpHeaders();
        headers.set("Authorization", "Bearer " + accessToken);
        headers.setContentType(MediaType.APPLICATION_JSON);

        // Fetch current contact to get its etag
        ...
        try {
            ...
            if (firstName != null && !firstName.isEmpty() && lastName != null && !lastName.isEmpty()) {
                requestBody.putArray("names").addObject()
