...
import com.amores.peopleapi.model.Contact;
...
public class ContactsController {
    ...
    /**
     * Render the Thymeleaf contacts.html page at GET /contacts
     */
    @GetMapping
    ...
    /**
     * Provide JSON data at GET /contacts/data The frontend JavaScript in
     * contacts.html will call /contacts/data to fetch contacts.
     */
    @GetMapping("/data")
    public ResponseEntity<?> getGoogleContacts(@AuthenticationPrincipal OAuth2User user) {
        ...
        try {
            String contactsJson = googleContactsService.getContacts(accessToken);
